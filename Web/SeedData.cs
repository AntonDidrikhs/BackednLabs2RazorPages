...
public static class SeedData
{
    public static void Seed(this WebApplication app)
    {
        using (var scope = app.Services.CreateScope())
        {
            ...
            quizRepo.Add(new Quiz(id: 1, items: quizItems, title: "Math"));


            quizItems.Add(quizItemRepo.Add(new QuizItem(id: 4, correctAnswer: "2", question: "3 - 1",
            ...
            quizRepo.Add(new Quiz(id: 2, items: quizItems, title: "Meth"));
        }
    }
}